...
if(version_compare(PHP_VERSION,'7.4.0')<0){die('需要 PHP 7.4.0 或更高版本, 当前版本是: '.PHP_VERSION);}
...
if(!file_exists(realpath(dirname(__FILE__))."/datasets/config.inc.php")){die("<b>随心远航</b>系统尚未初始化。<br><br>即将启动 <a href='setup.php'>配置</a> 程序！");}
