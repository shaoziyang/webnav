...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<?= $APP->PATH ?>styles/user.css" media="screen,projection"/>
	<link type="text/css" rel="stylesheet" href="<?= $APP->PATH ?>styles/wallpaper.css" media="screen,projection"/>
