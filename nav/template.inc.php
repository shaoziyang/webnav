      ...
      <span>
		...
		<div class="row">
			...
			<div class="col s12 hide-on-large-only">
				<p class="center-align"><small><?php include 'scripts/showcounter.php'; ?><script>document.write('<br><a href="<?= $APP->PATH ?>scripts/changewallpaper.php" title='+back_image+'>更换背景</a>(<a href="<?= $APP->PATH ?>scripts/showimagefile.php" title="显示背景图像列表">'+back_image+'</a>)');</script></small></p>
