      ...
      <span>
		...
		<div class="row">
			<div class="col m5 offset-m1 hide-on-med-and-down">
				<p class="left-align"><small><?php include 'scripts/showcounter.php'; ?>&emsp;<script>document.write('<a href="<?= $APP->PATH ?>scripts/showimagelist.php" title="显示系统背景图库">背景图库</a>');</script></small></p>
			</div><!-- /col -->
			...
			<div class="col s12 hide-on-large-only">
				<p class="center-align"><small><?php include 'scripts/showcounter.php'; ?><script>document.write('<br><a href="<?= $APP->PATH ?>scripts/showimagelist.php" title="显示系统背景图库">背景图库</a>');</script></small></p>
